...
class SkinnedMesh
    ...
    public:
        ...
        void BoneTransform(double frameTime, vector<mat4>& Transforms);
        void print_animation(int animation);
        void print_animations(int showall);
        void print_bones(const aiNode* pNode, int lvl = 0);
        void print_bones();
        ...
        mat4 GetMountMatrix(string bonename);
        void AddBoneTransformation(string bonename, mat4 M);
        ...
        void SetAnimTotalTime(double time) {
           timeInSeconds = time;
        }
...
private:
    ...
    double nextAnimTimeInSeconds = 0;
    float blendfactor = 0;
...
#define NUM_BONES_PER_VEREX 4
        ...
        struct BoneInfo
            ...
            mat4 AdditionalTransformation;
            mat4 MountTransformation;

            BoneInfo()
                {
                AdditionalTransformation = mat4(1);
                BoneOffset = mat4(0);
        ...
        void ReadNodeHeirarchy(const aiNode* pNode, const mat4& ParentTransform, double AnimationTime, double nextAnimationTime);
